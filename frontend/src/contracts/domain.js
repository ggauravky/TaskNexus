...
export const ORGANIZATION_MANAGEMENT_MODE = toEnum(domain.organizationManagementModes);
export const ORGANIZATION_ROLE = toEnum(domain.organizationRoles);
export const ORGANIZATION_INVITATION_STATUS = toEnum(domain.organizationInvitationStatuses);
...
export const OPPORTUNITY_APPLICATION_MODE = toEnum(domain.opportunityApplicationModes);
export const NATIVE_APPLICATION_STAGE = toEnum(domain.nativeApplicationStages);
export const NATIVE_APPLICATION_TRANSITIONS = Object.freeze(domain.nativeApplicationTransitions);
