...
const CollaborationPage = () => {
  ...
  const act = async (item, action) => {
    ...
    try {
      ...
      const successMessage = { accept: "Request accepted", decline: "Request declined", cancel: "Request cancelled" }[action];
      toast.success(successMessage); await load();
